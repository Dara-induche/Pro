          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: AppFont.textStyleHeader(fontSize: 16,fontWeight: FontWeight.w400,color: AppColor.greyColor),
              ...
              ElevatedButton(onPressed: (){},
                  child: Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      const Icon(FontAwesomeIcons.buildingCircleArrowRight,size: 16,),
                      const SizedBox(width: AppDimension.appSpaceVertical,),
                      Text(
                        "Add Property".tr,
                        style: AppFont.textStyleTitle(fontSize: 16,color: AppColor.whiteColor),
                      )
                    ],
                  )
              )
